  ...
  function query_all_the_post_types_custom_menu_page(){
      ...
      echo '<h2>Query All The Post Types</h2>';
        echo '<div class="row">';
          ...
          echo '<p><img style="padding:6px;" align="left" src="' . plugin_dir_url( __FILE__) . '/img/cptui.png" width="100" height="100">';
          ...
          echo '<div style="border:1px solid #e5e5e5; padding:10px; margin-bottom:10px;">';
          echo '<h4>Pods</h4>';
          echo '<p><img style="padding:6px;" align="left" src="' . plugin_dir_url( __FILE__) . '/img/pods.png" width="100" height="100">';
          ...
          echo '<p><img style="padding:6px;" align="left" src="' . plugin_dir_url( __FILE__) . '/img/cptuiextended.png" width="100" height="100">';
        ...
        echo '<hr />';
        echo 'Query All The Post Types | Version 1.3';
      echo '</div>';
    };
