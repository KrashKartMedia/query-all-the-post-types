  ...
  function query_all_the_post_types_custom_menu_page(){
      ...
      echo '<h2>Query All The Post Types</h2>';
        echo '<div class="row">';
          ...
          //add thickbox
            add_thickbox();
            echo '<div id="modal-window-id" style="display:none;"><p><h5>Post Types Being Excluded From Our List</h5> <ul><li>revision</li><li>nav_menu_item</li><li>edd_log</li><li>edd_payment</li><li>edd_discount</li><li>product_variation</li><li>shop_order_refund</li></li><li>product_type</li><li>tribe-ea-record</li><li>deleted_event</li></ul></p></div>';
          //stop thickbox
        ...
        echo '<hr />';
        echo 'Query All The Post Types | Version 1.6.1';
      echo '</div>';
    };
?>