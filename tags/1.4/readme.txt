...
A quick and easy way to view a list of all the post types & taxonomies currently registered on your WordPress Install.

== Description ==

> This Plugin won Second Place in the 2016 WordCamp Orange County Plugin-a-Palooza
...
Why stop there? We have taken this one step further and included all taxonomies registered to a post type.
...
We have excluded a few post types / taxonomies from Easy Digital Downloads & WooCommerce. Mostly because there is not a proper way to link them in the plugin options page.
