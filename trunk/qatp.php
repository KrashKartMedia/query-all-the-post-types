  ...
  function query_all_the_post_types_function() {
    ...
    foreach ( $all_post_types as $post_type ) {
        ...
        if ( in_array( $post_type, array( 'revision', 'nav_menu_item', 'edd_log', 'edd_payment', 'edd_discount', 'product_variation', 'shop_order_refund' ) ) ) {
          ...
          echo '<div>';
          echo 'Post Type: ' . esc_attr__( $post_type ) . '<p><a class="posttype" href="' . admin_url( 'edit.php?post_type=' . $post_type ) . '"> See all the posts in ' . esc_attr__( $post_type ) . '&rsquo;s</a>';
          echo '<hr />';
          ...
          foreach ( $taxonomy_objects as $taxonomy_object ) {
            ...
            // Custom stuff here
              ...
              echo '<em><a class="posttype" href="' . admin_url( 'edit-tags.php?taxonomy=' . $taxonomy_object . '&post_type=' . $post_type ) . '"> See all the posts in ' . esc_attr__( $taxonomy_object ) . '&rsquo;s</a></em></p>';
            }
          }
