...
( function() {
	...
	var tabs = document.querySelectorAll( '.qatp-tab' );
	var panels = document.querySelectorAll( '.qatp-tab-panel' );
	...
	function activateTab( tab ) {
		...
		var panel = document.getElementById( 'qatp-panel-' + tab.getAttribute( 'data-tab' ) );
		if ( panel ) {
	...
	var toggles = document.querySelectorAll( '.qatp-toggle' );
	...
	toggles.forEach( function( button ) {
		button.addEventListener( 'click', function() {
			...
			if ( el ) {
				var isHidden = 'none' === el.style.display;
